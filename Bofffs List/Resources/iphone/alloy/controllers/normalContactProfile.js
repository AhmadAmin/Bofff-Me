function Controller() {
    ...
    $.__views.view_container.add($.__views.__alloyId31);
    ...
    $.__views.__alloyId31.add($.__views.lbl_contactName);
    ...
    close ? $.__views.__alloyId32.addEventListener("click", close) : __defers["$.__views.__alloyId32!click!close"] = true;
    ...
    __defers["$.__views.__alloyId32!click!close"] && $.__views.__alloyId32.addEventListener("click", close);
