function Controller() {
    ...
    __alloyId76.push($.__views.toolbarBtn_cancel);
    ...
    __alloyId76.push($.__views.toolbarBtn_done);
    $.__views.__alloyId74 = Ti.UI.iOS.createToolbar({
        items: __alloyId76,
        top: "0",
        id: "__alloyId74"
    });
    $.__views.pickerview.add($.__views.__alloyId74);
