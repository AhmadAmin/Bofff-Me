function Controller() {
    ...
    this.__controllerPath = "view_customField";
    ...
    $.__views.view_customField.add($.__views.__alloyId45);
    ...
    $.__views.__alloyId45.add($.__views.img_closeCustomView);
    $.__views.txt_customField = Ti.UI.createTextField({
        id: "txt_customField",
        hintText: "Type in the custom attribute to search with",
        height: Ti.UI.SIZE,
        width: "90%"
    });
